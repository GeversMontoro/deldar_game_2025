#!/usr/bin/env Rscript
# Multilevel Mediation Analysis: Flow Mediation of Game Effects on Pain Intensity
# 
# This script performs multilevel mediation analysis to test whether Flow mediates 
# the effects of game conditions (Game MP vs. Game LP, 2-back, and LR) on pain intensity.
# The analysis uses a multilevel modeling approach with bootstrapping to estimate 
...
write.csv(results, "mediation_results_intensity.csv", row.names = FALSE)
cat("\nResults saved to 'mediation_results_intensity.csv'\n") 
